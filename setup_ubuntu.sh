...
if [ -f ".env" ]; then
    ...
    echo "   If you need to reset your .env file, please:"
    echo "   1. Create a backup: cp .env backups/.env.backup.\$(date +%Y%m%d_%H%M%S)"
    echo "   2. Manually delete .env file"
    echo "   3. Run this script again to create from template"
