...
class MarketVoicesApp:
    ...
    def run_daily_workflow(self) -> Dict:
        """Run the complete daily workflow using comprehensive data collection"""
        self.logger.info("Starting Market Voices daily workflow with comprehensive data collection")
        ...
        try:
            # Step 1: Collect market data using comprehensive workflow
            self.logger.info("Step 1: Collecting market data (Comprehensive Workflow)")
            market_data = comprehensive_collector.collect_comprehensive_data()
            workflow_result['steps']['data_collection'] = market_data
            
            if not market_data.get('collection_success', False):
                self.logger.error("Comprehensive data collection failed")
            ...
            self.logger.info("Daily workflow completed successfully with comprehensive data collection")
